...
<body>
    <div class="skin_color">
        <div class="skin_set">
            <div class="skin">
                ...
                <input style="margin-left:1700px;margin-top:-24px; " type="button" class="back_bn" onclick="window.location.href='../../../manager/manager.jsp'" value="清空">
            </div>
        </div>
    </div>
    <div class="div1">
    ...
    <div class="div2">
      <div>
        <div class="content">
            <iframe class="iframeRight" src="${pageContext.request.contextPath}/jsp/manager/carInfo/Content.jsp"> </iframe>
        </div>
      </div>
    </div>
