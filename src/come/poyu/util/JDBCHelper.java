...
public final class JDBCHelper {
    ...
    * 函数返回路径*/
    ...
    public static final String[] excuteQueryMore(String sql, String str, Object... params) {
        String[] arr = new String[0];
        try {
            Connection conn = DriverManager.getConnection(DB_URL, DB_LOGIN_NAME, DB_LOGIN_PWD);//建立connection
            Statement stmt = conn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_UPDATABLE);
    ...
    public static final <T> List<T> executeQueryMore(String sql, Class<T> clazz, int count,Object...params) {
        List<T> result = new ArrayList<T>();
        Connection conn = null;
        PreparedStatement pstmt = null;
        ResultSet rs = null;
